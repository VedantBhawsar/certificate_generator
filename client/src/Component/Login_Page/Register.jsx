                            ...
                            <div className='mr-7'>
                                ...
                                <div className='flex justify-between'>
                                    <div className="mb-6">
                                        <input
                                            type="text"
                                            className="form-control block w-11/12 px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                            ...
                            <div className="flex justify-between items-center mb-6 mr-7">
                                <div className="form-group form-check justify-center">
                                    <input
                                        ...
                                        id="exampleCheck3"
                                    />
                                    <label className="form-check-label inline-block text-gray-800 mr-6" for="exampleCheck3"
                                    >Remember me</label
                                    >
                                </div>
                            </div>
